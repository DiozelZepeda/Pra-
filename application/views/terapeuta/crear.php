...
<form class="form-horizontal" action="http://localhost:8888/pra/terapeuta/insert_alumno" method="post" accept-charset="utf-8">  
    <fieldset>  
...
<!-- pais residente del alumno -->
          	<div class="control-group">  
            	<label class="control-label" id="sexo" for="sexo">Sexo:</label>  
            	<div class="controls">  
...
<!-- Fecha nacimiento del alumno  -->
		...
		<div class="control-group">  
            <label class="control-label" for="fnacimiento">Fecha nacimiento :</label>  
    		 <div class="input-append date" id="dpYears" data-date="12/02/2012" data-date-format="dd/mm/yyyy" data-date-viewmode="years">  
              		<!-- <input type="text" class="input-xlarge" id="fnacimiento"> 
              		<input class="span2" value="02-16-2012" id="dp5" type="text">
              		<?= form_input(array('type'=>'text','class'=>'input-xlarge', 'name'=>'fnacimiento', 'id'=>'fnacimiento', 'value'=>set_value('fnacimiento'))); ?> -->
        			<input class="span2" name="fnacimiento" id="fnacimiento" size="16" type="text" value="12/02/2012" readonly>
      	...
      	<div class="control-group">  
            ...
            <div class="controls">  
              <textarea class="input-xlarge" id="diagnostico" name="diagnostico" rows="3"></textarea> 
             <!-- <?= form_input(array('type'=>'textarea', 'class'=>'input-xlarge','name'=>'nombre', 'id'=>'nombre', 'value'=>set_value('nombre'))); ?> -->
            </div>  
         </div> 
         ...
         <div class="control-group">  
            ...
            <div class="controls">  
              <textarea class="input-xlarge" id="tratamiento" name="tratamiento" rows="3"></textarea>  
         ...
         <div class="control-group">  
            ...
            <div class="controls">  
              <textarea class="input-xlarge" id="habilidades" name="habilidades" rows="3"></textarea> 
              <!-- <?= form_input(array('type'=>'text', 'name'=>'nombre', 'id'=>'nombre', 'value'=>set_value('nombre'))); ?>  -->
            </div>  
         </div> 
		...
		<div class="control-group">  
            	...
            	<div class="controls">  
              		<!--<input type="text" class="input-xlarge" name="escuela" id="escuela"> -->
              	    <?= form_input(array('type'=>'text', 'name'=>'escuela', 'id'=>'escuela', 'value'=>set_value('escuela'))); ?> 
            	</div>  
          	</div> 
		...
		<select name="pais">
           ...
           <!-- identificador de usuario en la base de datos-->
        	<div class="control-group">  
